...
echo "[RESULT-CSV-LABELS] PolicyId${CSV_SEPARATOR} RequestId${CSV_SEPARATOR} STMS${CSV_SEPARATOR} BRANCH${CSV_SEPARATOR} LINE${CSV_SEPARATOR} COMPLEXITY${CSV_SEPARATOR} Test List Size${CSV_SEPARATOR} Test List"
echo "[RESULT-CSV-INITIAL-COVERAGE] ${ID_POLICY}${CSV_SEPARATOR} ${ID_REQUEST}${CSV_SEPARATOR} ${INITIAL_COVERAGE_STMS}${CSV_SEPARATOR} ${INITIAL_COVERAGE_BRANCH}${CSV_SEPARATOR} ${INITIAL_COVERAGE_LINE}${CSV_SEPARATOR} ${INITIAL_COVERAGE_COMPLEXITY}${CSV_SEPARATOR} ${INITIAL_TEST_LIST_SIZE}${CSV_SEPARATOR} ${INITIAL_TEST_LIST}"
echo "[RESULT-CSV-INITIAL-COVERAGE-PERCENTUAL] ${ID_POLICY}${CSV_SEPARATOR} ${ID_REQUEST}${CSV_SEPARATOR} ${INITIAL_COVERAGE_STMS_PERCENTUAL}%${CSV_SEPARATOR} ${INITIAL_COVERAGE_BRANCH_PERCENTUAL}%${CSV_SEPARATOR} ${INITIAL_COVERAGE_LINE_PERCENTUAL}%${CSV_SEPARATOR} ${INITIAL_COVERAGE_COMPLEXITY_PERCENTUAL}%${CSV_SEPARATOR} ${INITIAL_TEST_LIST_SIZE}${CSV_SEPARATOR} ${INITIAL_TEST_LIST}"
echo "[RESULT-CSV-FINAL-COVERAGE] ${ID_POLICY}${CSV_SEPARATOR} ${ID_REQUEST}${CSV_SEPARATOR} ${COVERAGE_STMS}${CSV_SEPARATOR} ${COVERAGE_BRANCH}${CSV_SEPARATOR} ${COVERAGE_LINE}${CSV_SEPARATOR} ${COVERAGE_COMPLEXITY}${CSV_SEPARATOR} ${TEST_LIST_SIZE}${CSV_SEPARATOR} ${TEST_LIST}"
echo "[RESULT-CSV-FINAL-COVERAGE-PERCENTUAL] ${ID_POLICY}${CSV_SEPARATOR} ${ID_REQUEST}${CSV_SEPARATOR} ${COVERAGE_STMS_PERCENTUAL}%${CSV_SEPARATOR} ${COVERAGE_BRANCH_PERCENTUAL}%${CSV_SEPARATOR} ${COVERAGE_LINE_PERCENTUAL}%${CSV_SEPARATOR} ${COVERAGE_COMPLEXITY_PERCENTUAL}%${CSV_SEPARATOR} ${TEST_LIST_SIZE}${CSV_SEPARATOR} ${TEST_LIST}"
